...
class ImageResize
{
    ...
    /**
     * Create instance from a base64 encoded string
     *
     * @param string $image_data
     * @return ImageResize
     * @throws \exception
     */
    public static function createFromBase64String($image_data)
    {
        $resize = new self('data://application/octet-stream;base64,' . $image_data);
        return $resize;
    }
